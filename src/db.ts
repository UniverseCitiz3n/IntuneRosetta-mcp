 ...
 * Defender CSP Configuration node (device_vendor_msft_defender_configuration*),
 * ADMX-backed policy templates (device_vendor_msft_policy_config_admx*).
 *
...
export function seedDatabase(): void {
  ...
  const seedData: Array<Omit<PolicyRecord, 'id'>> = [
    ...
    // ─── Defender Configuration (Defender CSP /Configuration node) ───────────
    {
      normalized_key: 'device_vendor_msft_defender_configuration_engineupdateschannel',
      name: 'Defender Configuration: Engine updates channel',
      description: 'Configures the deployment ring for Microsoft Defender engine updates. Staged rollout reduces the risk of a buggy update reaching all devices simultaneously.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/EngineUpdatesChannel',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationengineupdateschannel',
      value_map: JSON.stringify({ '0': 'Not configured (gradual release)', '2': 'Beta Channel', '3': 'Current Channel (Preview)', '4': 'Current Channel (Staged)', '5': 'Current Channel (Broad)', '6': 'Critical – 48 h delay' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_platformupdateschannel',
      name: 'Defender Configuration: Platform updates channel',
      description: 'Configures the deployment ring for Microsoft Defender Antivirus platform (client binary) updates.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/PlatformUpdatesChannel',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationplatformupdateschannel',
      value_map: JSON.stringify({ '0': 'Not configured (gradual release)', '2': 'Beta Channel', '3': 'Current Channel (Preview)', '4': 'Current Channel (Staged)', '5': 'Current Channel (Broad)', '6': 'Critical – 48 h delay' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_securityintelligenceupdateschannel',
      name: 'Defender Configuration: Security intelligence updates channel',
      description: 'Configures the deployment ring for Microsoft Defender security intelligence (definition/signature) updates.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/SecurityIntelligenceUpdatesChannel',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationsecurityintelligenceupdateschannel',
      value_map: JSON.stringify({ '0': 'Not configured', '4': 'Current Channel (Staged)', '5': 'Current Channel (Broad)' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_disablecputhrottleonidlescans',
      name: 'Defender Configuration: Disable CPU throttle on idle scans',
      description: 'When enabled, Defender uses maximum available CPU resources during idle scans instead of being throttled.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/DisableCpuThrottleOnIdleScans',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationdisablecputhrottleonidlescans',
      value_map: JSON.stringify({ '0': 'CPU throttle enabled (lower CPU impact)', '1': 'CPU throttle disabled (max CPU usage)' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_enablefilehashcomputation',
      name: 'Defender Configuration: Enable file hash computation',
      description: 'Enables computing of file hashes for every executable scanned. Required for certain EDR and threat-hunting scenarios.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/EnableFileHashComputation',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationenablefilehashcomputation',
      value_map: JSON.stringify({ '0': 'Disabled', '1': 'Enabled' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_hideexclusionsfromlocaladmins',
      name: 'Defender Configuration: Hide exclusions from local admins',
      description: 'Prevents local administrators from viewing or modifying the antivirus exclusion list via Windows Security or PowerShell.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/HideExclusionsFromLocalAdmins',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationhideexclusionsfromlocaladmins',
      value_map: JSON.stringify({ '0': 'Exclusions visible to local admins', '1': 'Exclusions hidden from local admins' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_hideexclusionsfromlocalusers',
      name: 'Defender Configuration: Hide exclusions from local users',
      description: 'Prevents standard local users from viewing the antivirus exclusion list via Windows Security or PowerShell.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/HideExclusionsFromLocalUsers',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationhideexclusionsfromlocalusers',
      value_map: JSON.stringify({ '0': 'Exclusions visible to local users', '1': 'Exclusions hidden from local users' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_oobeenablertpandsigupdate',
      name: 'Defender Configuration: OOBE enable real-time protection and signature update',
      description: 'Ensures real-time protection and security intelligence updates are active during the Out-of-Box Experience, before user sign-in.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/OobeEnableRtpAndSigUpdate',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationoobeenablertpandsigupdate',
      value_map: JSON.stringify({ '0': 'Not enabled during OOBE', '1': 'Enabled during OOBE' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_passiveremediation',
      name: 'Defender Configuration: Passive remediation',
      description: 'Controls threat remediation behaviour when Defender Antivirus runs in passive mode alongside a third-party AV product.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/PassiveRemediation',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationpassiveremediation',
      value_map: JSON.stringify({ '0': 'Disabled (default)', '1': 'Sense auto-remediation', '2': 'RTP audit', '4': 'RTP remediation' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_devicecontrolenabled',
      name: 'Defender Configuration: Device Control enabled',
      description: 'Enables or disables Microsoft Defender Device Control, which governs access to peripheral devices such as USB drives and printers.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/DeviceControlEnabled',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationdevicecontrolenabled',
      value_map: JSON.stringify({ '0': 'Disabled', '1': 'Enabled' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_defaultenforcement',
      name: 'Defender Configuration: Default enforcement (Device Control)',
      description: 'Sets the default Device Control enforcement action when no policy rule matches the access request.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/DefaultEnforcement',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationdefaultenforcement',
      value_map: JSON.stringify({ '1': 'Default Allow', '2': 'Default Deny' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_disablelocaladminmerge',
      name: 'Defender Configuration: Disable local admin merge',
      description: 'Prevents local admins from adding exclusions, threat type settings, or remediation actions that would merge with MDM policy.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/DisableLocalAdminMerge',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationdisablelocaladminmerge',
      value_map: JSON.stringify({ '0': 'Allow local admin merge', '1': 'Disable local admin merge' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_disablegradualrelease',
      name: 'Defender Configuration: Disable gradual release',
      description: 'Disables staged rollout of Defender Antivirus daily updates so devices receive all updates immediately instead of in waves.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/DisableGradualRelease',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationdisablegradualrelease',
      value_map: JSON.stringify({ '0': 'Gradual release enabled', '1': 'Gradual release disabled' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_meteredconnectionupdates',
      name: 'Defender Configuration: Metered connection updates',
      description: 'Allows Microsoft Defender security intelligence updates to be downloaded over metered (pay-per-use) network connections.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/MeteredConnectionUpdates',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationmeteredconnectionupdates',
      value_map: JSON.stringify({ '0': 'Not allowed on metered connections', '1': 'Allowed on metered connections' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_allownetworkprotectiononwinserver',
      name: 'Defender Configuration: Allow network protection on Windows Server',
      description: 'Controls whether Microsoft Defender Network Protection can be configured to block or audit mode on Windows Server.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/AllowNetworkProtectionOnWinServer',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationallownetworkprotectiononwinserver',
      value_map: JSON.stringify({ '0': 'Disallow', '1': 'Allow' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_allownetworkprotectiondownlevel',
      name: 'Defender Configuration: Allow network protection on downlevel Windows',
      description: 'Controls whether Network Protection can be enabled on Windows versions prior to RS3 (Fall Creators Update).',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/AllowNetworkProtectionDownLevel',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationallownetworkprotectiondownlevel',
      value_map: JSON.stringify({ '0': 'Disabled downlevel', '1': 'Enabled downlevel' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_performancemodestatus',
      name: 'Defender Configuration: Performance mode status',
      description: 'Enables performance mode for Microsoft Defender Antivirus on Windows 11 Dev Drive. A service restart is required after changing this value.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/PerformanceModeStatus',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationperformancemodestatus',
      value_map: JSON.stringify({ '0': 'Performance mode enabled (default)', '1': 'Performance mode disabled' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_enableconvertwarntoblock',
      name: 'Defender Configuration: Convert warn verdicts to block',
      description: 'Promotes Warn (audit) verdicts to Block for attack surface reduction rules, controlled folder access, and network protection.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/EnableConvertWarnToBlock',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationenableconvertwarntoblock',
      value_map: JSON.stringify({ '0': 'Warn verdicts remain as warn', '1': 'Warn verdicts promoted to block' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_scanonlyifidleenabled',
      name: 'Defender Configuration: Scan only if idle',
      description: 'When enabled, Defender scheduled scans only run when the system is not actively in use, reducing impact on interactive users.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/ScanOnlyIfIdleEnabled',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationscanonlyifidleenabled',
      value_map: JSON.stringify({ '0': 'Scan regardless of system state', '1': 'Scan only when system is idle' } as ValueMap),
    },
    {
      normalized_key: 'device_vendor_msft_defender_configuration_schedulesecurityintelligenceupdateday',
      name: 'Defender Configuration: Schedule security intelligence update day',
      description: 'Specifies the day of the week on which scheduled security intelligence (definition) updates are downloaded.',
      csp_path: './Device/Vendor/MSFT/Defender/Configuration/ScheduleSecurityIntelligenceUpdateDay',
      category: 'Defender Configuration',
      docs_url: 'https://learn.microsoft.com/en-us/windows/client-management/mdm/defender-csp#configurationschedulesecurityintelligenceupdateday',
      value_map: JSON.stringify({ '0': 'Daily', '1': 'Sunday', '2': 'Monday', '3': 'Tuesday', '4': 'Wednesday', '5': 'Thursday', '6': 'Friday', '7': 'Saturday', '8': 'Never' } as ValueMap),
    },
  ];
